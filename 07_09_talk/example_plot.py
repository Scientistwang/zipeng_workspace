...
plt.plot(traj_2D_2[:,0], traj_2D_2[:,1],label = 'Trajectory')
...
plt.scatter([0],[1],facecolor = 'g',edgecolor = 'g',s=80,label = 'Steady States')
plt.scatter([.5],[.5],facecolor = 'b',edgecolor = 'b',s=80,label = 'Initial Conditions')
plt.scatter([1.1],[.3],facecolor = 'b',edgecolor = 'b',s=80)
