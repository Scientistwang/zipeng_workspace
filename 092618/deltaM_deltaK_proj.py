...
plt.scatter(M_0[0],M_0[1],facecolor = 'b',edgecolor = 'b',label = "unchanged M")
plt.scatter(M_1[0],M_1[1],facecolor = 'r',edgecolor = 'r',s = 100,label = "changed M")
...
plt.scatter(M_new[0],M_new[1],facecolor = 'g',edgecolor = 'g',label = "projection of K")
...
filename = 'figs/projection_delta_K.pdf'
